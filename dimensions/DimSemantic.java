...
*/
   ...
   @Override public Symbol visitRelativeDim(dimensionsParser.RelativeDimContext ctx) {
      ...
      /*
      for (DimensionsType dimensionsType : dimensionsParser.dimTable.values()) {
         System.out.println("Dim: "+dimensionsType.name()+"\nUnits:{\n");
         dimensionsType.getUnits().forEach((k, v) -> {
         System.out.println(v+" conversion value:"+dimensionsType.getUnitConv(v));
          });
          System.out.println("}");
      }*/
      return null;
   ...
   @Override public Symbol visitUnit(dimensionsParser.UnitContext ctx) {
      ...
      DimensionsType.mapToString(dimType.getUnit());
      DimensionsType.mapToString(((DimensionsType)dimUnit).getUnit());
